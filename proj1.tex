...
\usepackage[text={18cm,24cm}, top=2cm, left=1.5cm]{geometry}
...
\author{Martina Zlevorová
(\texttt{\href{mailto:xzlevo00@stud.fit.vutbr.cz}{xzlevo00@stud.fit.vutbr.cz}})}
\date{}
...
\begin{quote}
Čím více \textbf{druhů,} \emph{řezů,} \footnotesize velikostí, \normalsize barev písma {\fontfamily{cmss}\selectfont a~jiných \textbf{\tiny efektů}} použijeme, tím \emph{profesionálněji} bude dokument vypadat. Čtenář tím {\large bude} {\LARGE vždy} \scshape {\Huge nadšen!}
\end{quote}
